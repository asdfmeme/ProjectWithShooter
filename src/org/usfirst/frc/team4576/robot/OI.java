...
import org.usfirst.frc.team4576.robot.commands.ControlIntake;
...
import org.usfirst.frc.team4576.robot.commands.StopShooter;
...
public class OI {
	...
	public OI() {
		...
		rb.whenPressed(new ControlIntake(true));
		lb.whenPressed(new ControlIntake(false));
		rb.whenReleased(new StopShooter());
		lb.whenReleased(new StopShooter());
